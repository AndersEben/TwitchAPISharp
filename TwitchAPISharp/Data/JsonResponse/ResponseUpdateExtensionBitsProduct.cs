...
{
    public class ResponseUpdateExtensionBitsProductData : TemplateResponseData<ResponseUpdateExtensionBitsProduct>
    {
    }

    public class ResponseUpdateExtensionBitsProduct
    {
        [JsonProperty]
