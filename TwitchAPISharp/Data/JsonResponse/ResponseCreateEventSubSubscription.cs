...
{
    public class ResponseCreateEventSubSubscriptionData : TemplateResponseData<ResponseCreateEventSubSubscription>
    {
        [JsonProperty]
    ...
    public class ResponseCreateEventSubSubscription
    {
        [JsonProperty]
