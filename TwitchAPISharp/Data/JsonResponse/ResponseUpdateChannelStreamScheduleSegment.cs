...
{
    public class ResponseUpdateChannelStreamScheduleSegmentData : TemplateResponseData<ResponseUpdateChannelStreamScheduleSegment>
    {

    }

    public class ResponseUpdateChannelStreamScheduleSegment
    {
        [JsonProperty]
